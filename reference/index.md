...
- [`arrangeCdmNames()`](https://mi-erasmusmc.github.io/studyGenerics/reference/arrangeCdmNames.md)
  : \`arrangeCdmNames()\` verifies if data partner's acronyms are valie
  and returns a vector ordered by country alphabetical order
- [`assertCdmNames()`](https://mi-erasmusmc.github.io/studyGenerics/reference/assertCdmNames.md)
  : \`assertCdmNames()\` verifies if data partner's names are correct
  and display an error if incorrect
- [`createResultsDir()`](https://mi-erasmusmc.github.io/studyGenerics/reference/createResultsDir.md)
  : Create directory for analysis results
- [`developCheckout()`](https://mi-erasmusmc.github.io/studyGenerics/reference/developCheckout.md)
  : \`developCheckout()\` is a wrapper for gert functions to swiftly
  default to develop and pull latest changes
...
- [`issueOpen()`](https://mi-erasmusmc.github.io/studyGenerics/reference/issueOpen.md)
  : \`issueOpen()\` is a wrapper for gh::gh() to swiftly post in the
  GitHub repository of the current project
- [`pullRequest()`](https://mi-erasmusmc.github.io/studyGenerics/reference/pullRequest.md)
