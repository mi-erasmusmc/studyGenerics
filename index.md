...
to save ATLAS concept-set definitions in
...
to replace values in a summarised-result column, for example when
preparing clearer cohort labels for presentation.
