...
vignette: >
  %\VignetteIndexEntry{macOS solves}
...
This depends on how Java was installed (package manager versus direct download).
...
You might receive an error related to gettext when installing an R package.
